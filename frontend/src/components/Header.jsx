    ...
    <header className="hdr-wrapper">
      ...
      <div className="hdr-utility-bar">
        <div className="hdr-utility-inner">
          <nav className="hdr-utility-links">
            <a href="#">My Honda+</a>
      ...
      <div className="hdr-nav-bar">
        <div className="hdr-nav-inner">
          <nav className="hdr-nav-links">
            <Link to="/" className="hdr-nav-item hdr-nav-active">Sản phẩm</Link>
            <a href="#" className="hdr-nav-item">Khuyến mãi</a>
            <a href="#" className="hdr-nav-item">Sự kiện</a>
            <a href="#" className="hdr-nav-item">Cửa hàng ủy nhiệm</a>
            <a href="#" className="hdr-nav-item hdr-has-dropdown">
              Dịch vụ sau bán hàng
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" strokeWidth="2" style={{ marginLeft: '4px' }}>
