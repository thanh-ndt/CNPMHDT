  ...
  return (
    <>
      ...
      <section className="py-5 bg-light" id="xe-noi-bat">
        <div className="container">
          <div className="text-center mb-5">
            <h2 className="display-5 fw-bold mb-2">Xe Honda nổi bật</h2>
            <p className="text-muted">Khám phá những mẫu xe Honda hot nhất hiện nay</p>
          </div>
      ...
      <section className="py-5" id="thuong-hieu">
        <div className="container">
          <div className="text-center mb-5">
            <h2 className="display-5 fw-bold mb-2">Các dòng xe Honda</h2>
